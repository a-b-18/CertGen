...
openssl ca -in /root/ca-root/requests/intermediate.csr -passin pass:1234 -out /root/ca-root/newcerts/intermediate.crt
...
openssl pkcs12 -export -out /root/ca-intermediate/newcerts/intermediate.pfx -inkey /root/ca-intermediate/private/intermediatekey.pem -in /root/ca-intermediate/intermediate.crt -passin pass:1234 -passout pass:1234
